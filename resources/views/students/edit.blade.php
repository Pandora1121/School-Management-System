...
<div class="container py-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="studentEditForm" method="POST" action="{{ route('students.update', $student->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">NIS <span class="text-danger">*</span></label>
                        <input type="text" name="nis" class="form-control" value="{{ $student->nis }}" autofocus required>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="id_major" class="form-select" required>
                            ...
                            @foreach ($majors as $major)
                                <option value="{{ $major->id }}" {{ $student->id_major == $major->id ? 'selected' : '' }}>
                                    {{ $major->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="id_class" class="form-select" required>
                            ...
                            @foreach ($classes as $class)
                                <option value="{{ $class->id }}" {{ $student->id_class == $class->id ? 'selected' : '' }}>
                                    {{ $class->name }}
                                </option>
                            @endforeach
                        </select>
